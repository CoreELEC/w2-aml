...
struct ipc_host_env_tag
{
    ...
    struct aml_ipc_buf *rxdesc[IPC_RXDESC_CNT + IPC_RXDESC_CNT_EXT];
    ...
    // Array of RX data buffers pushed to firmware
    struct aml_ipc_buf *rxbuf[IPC_RXBUF_CNT];
    ...
    struct aml_ipc_buf *radar[IPC_RADARBUF_CNT];
    ...
    struct aml_ipc_buf *unsuprxvec[IPC_UNSUPRXVECBUF_CNT];
    ...
    struct aml_ipc_buf *dbgbuf[IPC_DBGBUF_CNT];
