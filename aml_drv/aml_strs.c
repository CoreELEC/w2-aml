...
const char *const aml_mm_other_id2str[MM_SUB_A2E_MAX] = {
    [MM_SUB_RF_READ]                 = "MM_SUB_RF_READ",
    [MM_SUB_RF_WRITE]                = "MM_SUB_RF_WRITE",
    [MM_SCAN_HANG]                   = "MM_SCAN_HANG",
    [MM_SUB_SET_SUSPEND_REQ]         = "MM_SUB_SET_SUSPEND_REQ",
    [MM_SUB_SET_WOW_PATTERN]         = "MM_SUB_SET_WOW_PATTERN",
    [MM_SUB_SCANU_CANCEL_REQ]        = "MM_SUB_SCANU_CANCEL_REQ",
    [MM_SUB_ARP_AGENT_REQ]           = "MM_SUB_ARP_AGENT_REQ",
    [MM_SUB_SET_REKEY_DATA]          = "MM_SUB_SET_REKEY_DATA",
    [MM_SUB_TKO_CONFIG_REQ]          = "MM_SUB_TKO_CONFIG_REQ",
    [MM_SUB_TKO_ACTIVATE_REQ]        = "MM_SUB_TKO_ACTIVATE_REQ",
    [MM_SUB_SET_CALI_REQ]            = "MM_SUB_SET_CALI_REQ",
    [MM_SUB_GET_EFUSE]               = "MM_SUB_GET_EFUSE",
    [MM_SUB_SET_EFUSE]               = "MM_SUB_SET_EFUSE",
    [MM_SUB_FW_RESET]                = "MM_SUB_FW_RESET",
    [MM_SUB_SET_MACBYPASS]           = "MM_SUB_SET_MACBYPASS",
    [MM_SUB_SET_STOP_MACBYPASS]      = "MM_SUB_SET_STOP_MACBYPASS",
    [SCANU_SCHED_START_REQ]          = "SCANU_SCHED_START_REQ",
    [SCANU_SCHED_STOP_REQ]           = "SCANU_SCHED_STOP_REQ",
    [MM_SUB_SET_AMSDU_TX]            = "MM_SUB_SET_AMSDU_TX",
    [MM_SUB_SET_LDPC]                = "MM_SUB_SET_LDPC",
    [MM_SUB_SET_TX_LFT]              = "MM_SUB_SET_TX_LFT",
    [MM_SUB_SET_STBC_ON]             = "MM_SUB_SET_STBC_ON",
    [MM_SUB_COEX_CMD]                = "MM_SUB_COEX_CMD",
    [MM_SUB_PCIE_DL_TEST]            = "MM_SUB_PCIE_DL_TEST",
    [MM_SUB_PCIE_UL_TEST]            = "MM_SUB_PCIE_UL_TEST",
    ...
    [MM_SCC_CONFLICT]                = "MM_SCC_CONFLICT",
    [MM_SYNC_TRACE]                  = "MM_SYNC_TRACE",
    [MM_SUB_DHCP_REQ]                = "MM_SUB_DHCP_REQ",
    [MM_EXT_CAPAB]                   = "MM_EXT_CAPAB",
    [MM_SUB_LIMIT_POWER]             = "MM_SUB_LIMIT_POWER",
    [MM_SUB_SHOW_TX_MSG]             = "MM_SUB_SHOW_TX_MSG",
    [MM_SUB_CSI_STATUS_COM_GET]      = "MM_SUB_CSI_STATUS_COM_GET",
    [MM_SUB_CSI_STATUS_SP_GET]       = "MM_SUB_CSI_STATUS_SP_GET",
    [MM_SUB_SET_DYNAMIC_BUF_STATE]   = "MM_SUB_SET_DYNAMIC_BUF_STATE",
    [MM_SUB_SET_LA_CAPTURE]          = "MM_SUB_SET_LA_CAPTURE",
    [MM_SUB_SET_LA_STATE]            = "MM_SUB_SET_LA_STATE",
    ...
    [MDNS_SET_WAKE_PORTS]            = "MDNS_SET_WAKE_PORTS",
...
static const char *const aml_scanid2str[MSG_I(SCAN_MAX)] = {
    [MSG_I(SCAN_START_REQ)]          = "SCAN_START_REQ",
    [MSG_I(SCAN_START_CFM)]          = "SCAN_START_CFM",
    [MSG_I(SCAN_DONE_IND)]           = "SCAN_DONE_IND",
};

static const char *const aml_tdlsid2str[MSG_I(TDLS_MAX)] = {
...
static const char *const aml_scanuid2str[MSG_I(SCANU_MAX)] = {
...
static const char *const aml_meid2str[MSG_I(ME_MAX)] = {
...
static const char *const aml_smid2str[MSG_I(SM_MAX)] = {
...
static const char *const aml_apmid2str[MSG_I(APM_MAX)] = {
...
static const char *const aml_meshid2str[MSG_I(MESH_MAX)] = {
...
static const char *const aml_twtid2str[MSG_I(TWT_MAX)] = {
...
const char *const *aml_id2str[TASK_LAST_EMB + 1] = {
    [TASK_MM]    = aml_mmid2str,
    [TASK_DBG]   = aml_dbgid2str,
    [TASK_SCAN]  = aml_scanid2str,
    [TASK_TDLS]  = aml_tdlsid2str,
#ifdef CONFIG_AML_FULLMAC
    [TASK_SCANU] = aml_scanuid2str,
    [TASK_ME]    = aml_meid2str,
    [TASK_SM]    = aml_smid2str,
    [TASK_APM]   = aml_apmid2str,
    [TASK_MESH]  = aml_meshid2str,
    [TASK_TWT]   = aml_twtid2str,
#endif
};
